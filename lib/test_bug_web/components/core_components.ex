defmodule TestBugWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(TestBugWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(TestBugWeb.Gettext, "errors", msg, opts)
    end
  end
